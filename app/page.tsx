...
const terminalData = {
  ...
  whois: [
    ...
    "Hello World!",
    "Hi I am Joshatoshi.",
    "15 years experience in Web3 & Blockchain. 7 in Traditional Finance.",
    "I build things, hardware and software.",
    "I talk about things on global stages and small gatherings alike. I love to share ideas and build.",
  ...
  const executeCommand = (cmd: string) => {
    ...
    switch (lowerCmd) {
      ...
      case "social":
        ...
        break
      case "email":
        setTerminalOutput([...newOutput, `Opening mailto:<a href="${terminalData.email}">hello@caimera.xyz</a>...`])
          ...
          <div className="modal-content manga-modal socials-modal" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="social-links-grid">
                ...
                <a href="https://caimera.one" target="_blank" rel="noopener noreferrer" className="social-link">
